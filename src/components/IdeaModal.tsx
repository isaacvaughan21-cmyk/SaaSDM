  ...
  return (
    <div className="fixed inset-0 z-40 flex items-start justify-center bg-black/40 p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl my-8">
        {/* sticky score header */}
        <div className="sticky top-0 bg-white border-b border-slate-200 rounded-t-xl px-6 py-4 z-10">
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          {PILLARS.map((pillar) => (
            <div key={pillar} className="rounded-lg border border-slate-200">
              <button
                type="button"
                className="w-full flex items-center justify-between px-4 py-2 text-left font-semibold text-slate-700"
              ...
              >
                ...
                <span className="text-slate-400">{open[pillar] ? '▾' : '▸'}</span>
              </button>
              {open[pillar] && (
        ...
        <div className="sticky bottom-0 bg-white border-t border-slate-200 rounded-b-xl px-6 py-3 flex justify-end gap-3">
          <button
            onClick={onCancel}
