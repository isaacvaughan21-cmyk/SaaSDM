    ...
    <div className="fixed inset-0 z-40 flex justify-end bg-black/40">
      <div className="bg-white w-full max-w-md h-full overflow-y-auto shadow-xl">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <h2 className="text-lg font-bold text-slate-800">⚙ Sub-criteria weights</h2>
        ...
        <div className="px-6 py-4 space-y-5">
          ...
          {PILLARS.map((p) => {
            ...
            const valid = t === 100;
            return (
              <div key={p} className="rounded-lg border border-slate-200 p-4">
        ...
        <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 py-3 flex justify-between">
          <button
